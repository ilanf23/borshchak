...
const post: BlogPostData = {
  ...
  sections: [
    ...
    { type: "paragraph", content: "The UCCJEA establishes clear rules for determining which state's court has jurisdiction over a custody case. The primary consideration is the child's \"home state,\" which is where the child has lived for at least six consecutive months before the custody proceedings began. If no state meets this definition, courts look at significant connections, such as family, school, or medical care in a particular state." },
