import blogHeroImage from "@/assets/services/annulment.jpg";
...
const post: BlogPostData = {
  ...
  sections: [
    ...
    { type: "heading", content: "Options for Your House in a Columbus, OH Divorce" },
    { type: "paragraph", content: "When facing a divorce in Columbus, OH, you'll need to decide what to do with your marital home. The three primary options are: selling the home and dividing the proceeds, arranging a buyout where one spouse keeps the house, or continuing to co-own the property after the divorce. Each approach comes with unique legal, financial, and emotional considerations." },
    { type: "paragraph", content: "Selling the home is often the simplest solution. Both spouses agree to put the house on the market, pay off any remaining mortgage, and split the net proceeds. This option provides a clean break and can help both parties move forward. However, it may not be ideal if children are involved or if the market conditions are unfavorable." },
    { type: "paragraph", content: "A buyout allows one spouse to keep the home by paying the other spouse their share of the home's equity. This can be a good option if one party wants to maintain stability for children or has a strong emotional attachment to the property. However, the buying spouse must be able to refinance the mortgage in their name and come up with the necessary funds for the buyout, which can be challenging." },
    { type: "paragraph", content: "In some cases, ex-spouses choose to co-own the home for a period of time after the divorce, often until children graduate or the market improves. This arrangement requires clear agreements on responsibilities and a high level of trust. If you're unsure which path is right for you, consulting a reputable law firm in Columbus, OH can provide the guidance you need to make a confident decision." },
    ...
    { type: "heading", content: "How Ohio Courts Classify Marital and Separate Property" },
    { type: "paragraph", content: "A key step in any Ohio divorce is determining what portion of your home is marital property and what, if any, is separate property. Marital property includes assets acquired by either spouse during the marriage, regardless of whose name is on the title. Separate property, on the other hand, refers to assets owned by one spouse before the marriage, or those received as a gift or inheritance." },
    { type: "paragraph", content: "The distinction is crucial: only marital property is subject to division in divorce proceedings. If you purchased your house together after getting married, it's almost always marital property. However, if one spouse owned the home before the marriage and the other contributed to the mortgage or renovations, the increase in value due to those contributions may be considered marital, while the original value remains separate." },
    { type: "paragraph", content: "Tracing the source of down payments, mortgage payments, and improvements is often necessary. Documentation such as bank statements, deeds, and receipts can be invaluable for proving what portion of the home's value is marital versus separate. If there's a dispute, the court may require expert testimony or appraisals to determine the value of each interest." },
    { type: "paragraph", content: "Understanding this classification early on can help you set realistic expectations and develop a negotiation strategy that protects your financial interests." },

    { type: "heading", content: "Sell, Buyout, or Co-Own: Pros and Cons of Each Option" },
    { type: "list", items: [
      "Selling the Home: Provides a clean break, liquidates the asset, and allows both parties to move on. However, it may disrupt children's lives and could result in financial loss if the market is down.",
    ...
    { type: "table", headers: ["Option", "Pros", "Cons"], rows: [
      ["Sell the Home", "Quick liquidity; clean break; splits proceeds; no ongoing ties", "May disrupt children; possible unfavorable market; moving hassles"],
      ["Buyout", "One spouse keeps home; stability for kids; emotional continuity", "Requires refinancing; large cash outlay; risk of overextending finances"],
      ["Co-Own", "Delay sale until market improves or kids graduate; shared expenses", "Requires cooperation; potential for conflict; unclear future plans"],
    ]},
    ...
    { type: "heading", content: "Practical Tips: Preparing for the Division of Your Home" },
    { type: "paragraph", content: "To ensure a smooth process, preparation is key. Start by gathering all relevant documents, including the deed, mortgage statements, tax records, and any paperwork related to improvements or repairs. Have the home professionally appraised to determine its fair market value, and consider obtaining a comparative market analysis from a local real estate agent." },
    { type: "paragraph", content: "If you're considering a buyout, check your credit score and research refinancing options early. For those exploring co-ownership, draft a clear agreement outlining each party's responsibilities for mortgage payments, taxes, insurance, and maintenance. If you plan to sell, agree on a realtor, listing price, and how proceeds will be divided." },
    { type: "list", items: [
    ...
    { type: "heading", content: "When to Seek Professional Legal Guidance" },
    { type: "paragraph", content: "Dividing a home in divorce is rarely straightforward. Disputes over property classification, valuation, or the best path forward can quickly escalate. If you and your spouse disagree on how to handle the house, or if your situation involves complex factors such as business ownership, inherited property, or significant home improvements, professional legal guidance is essential." },
    { type: "paragraph", content: "An experienced divorce attorney can help you understand your rights, negotiate favorable terms, and ensure all agreements are properly documented. They can also coordinate with financial advisors and real estate professionals to protect your interests. Even if you and your spouse are largely in agreement, a legal review can prevent costly errors and future disputes." },
